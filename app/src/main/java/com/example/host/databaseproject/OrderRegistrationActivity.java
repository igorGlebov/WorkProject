...
public class OrderRegistrationActivity extends AppCompatActivity {
    ...
    String path; private static final String IMAGE_DIRECTORY = "/signdemo";
    ...
    public String saveImage(Bitmap myBitmap) {
        ...
        try {
            ...
            MediaScannerConnection.scanFile(OrderRegistrationActivity.this, new String[]{f.getPath()}, new String[]{"image/jpeg"}, null);
            fo.close();
