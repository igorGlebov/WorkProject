 ...
 */
public class FlowersServiceFragment extends Fragment {
...
//        navigation.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener);
        ...
        layout = (RelativeLayout) view.findViewById(R.id.flowersServiceLayout);

        lSwipeDetector = new GestureDetectorCompat(getContext(), new FlowersServiceFragment.MyGestureListener());
